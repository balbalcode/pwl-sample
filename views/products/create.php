<?php $title = 'Create Product'; require_once __DIR__ . '/../layout/header.php'; ?>
            ...
            <div class="card-body">
                <form action="<?= BASE_URL ?>/products/store" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" rows="3" class="form-control <?= isset($errors['description']) ? 'is-invalid' : '' ?>"><?= htmlspecialchars($old['description'] ?? '') ?></textarea>
